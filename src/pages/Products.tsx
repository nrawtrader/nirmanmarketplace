...
import { Search, SlidersHorizontal, HardHat, Construction, Bath } from "lucide-react";
...
const categoryMeta: Record<ProductCategory, { label: string; icon: React.ReactNode; description: string }> = {
  ...
  steel: { label: "Steel", icon: <Construction className="w-6 h-6" />, description: "TMT bars & reinforcement steel" },
  sanitary: { label: "Sanitary", icon: <Bath className="w-6 h-6" />, description: "Pipes, fittings & bathroom essentials" },
};

const sectionOrder: ProductCategory[] = ["cement", "steel", "sanitary"];
